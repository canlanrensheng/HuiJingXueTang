...
- (void)layoutSubviews {
    ...
    _topControlView.frame = CGRectMake(0, 0, _overlayControl.width, 50);
    _playQuitBtn.frame = CGRectMake(8.0, 20, 50, 30);
    ...
    _scaleModeBtn.frame = CGRectMake(_bottomControlView.width - kPlayerBtnWidth-10*SW, 0, kPlayerBtnWidth, _bottomControlView.height);
