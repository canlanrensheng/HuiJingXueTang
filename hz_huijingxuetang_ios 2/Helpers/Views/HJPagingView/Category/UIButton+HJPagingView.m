...
@implementation UIButton (HJPagingView)
/**
 *  设置图片与文字样式
 *
...
- (void)HJ_imagePositionStyle:(HJImagePositionStyle)imagePositionStyle spacing:(CGFloat)spacing imagePositionBlock:(void (^)(UIButton *button))imagePositionBlock {
    ...
    if (imagePositionStyle == HJImagePositionStyleDefault) {
    ...
    } else if (imagePositionStyle == HJImagePositionStyleRight) {
    ...
    } else if (imagePositionStyle == HJImagePositionStyleTop) {
    ...
    } else if (imagePositionStyle == HJImagePositionStyleBottom) {
        CGFloat imageW = self.imageView.frame.size.width;
        CGFloat imageH = self.imageView.frame.size.height;
        CGFloat titleIntrinsicContentSizeW = self.titleLabel.intrinsicContentSize.width;
        CGFloat titleIntrinsicContentSizeH = self.titleLabel.intrinsicContentSize.height;
