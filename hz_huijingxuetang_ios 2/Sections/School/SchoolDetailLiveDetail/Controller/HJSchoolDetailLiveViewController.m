...
@interface HJSchoolDetailLiveViewController()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@property (nonatomic,strong) HJSchoolDetailAliveToolView *toolView;
...
- (void)hj_setNavagation {
    ...
    [toolView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(kHeight(210 + 65));
    }];
...
- (void)createCollectionView{
    ...
    [self.collectionMain mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.view).offset(kHeight(210 + 40 + 65));
        make.left.right.equalTo(self.view);
