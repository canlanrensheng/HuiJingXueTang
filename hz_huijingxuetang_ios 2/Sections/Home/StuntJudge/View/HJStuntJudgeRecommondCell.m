...
@interface HJStuntJudgeRecommondCell ()
...
@implementation HJStuntJudgeRecommondCell
...
- (void)hj_configSubViews {
    ...
    UIButton *loodDetailBtn = [UIButton creatButton:^(UIButton *button) {
        button.ljTitle_font_titleColor_state(@"查看详情",MediumFont(font(13)),HEXColor(@"#34BF86"),0);
    }];
