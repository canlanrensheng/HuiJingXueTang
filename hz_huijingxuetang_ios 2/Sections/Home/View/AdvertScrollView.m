...
#pragma mark - - -  AdvertScrollViewStyleNormal 样式下的 cell
@interface  AdvertScrollViewNormalCell : UICollectionViewCell
@property (nonatomic, strong) UIImageView *signImageView;
@property (nonatomic, strong) UILabel *titleLabel;
@end

@implementation  AdvertScrollViewNormalCell
...
#pragma mark - - -  AdvertScrollViewStyleMore 样式下的 cell
@interface  AdvertScrollViewMoreCell : UICollectionViewCell
...
@implementation  AdvertScrollViewMoreCell
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.backgroundColor = [UIColor clearColor];
...
- (void)layoutSubviews {
    ...
    CGFloat bottomLabelY = CGRectGetMaxY(self.topLabel.frame) + kHeight(5.0);
...
- (void)initialization {
    ...
    [self addTimer];
    _advertScrollViewStyle =  AdvertScrollViewStyleNormal;
}
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[ AdvertScrollViewNormalCell class] forCellWithReuseIdentifier:advertScrollViewNormalCell];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.advertScrollViewStyle ==  AdvertScrollViewStyleMore) {
        ...
        return cell;
         ...
         AdvertScrollViewNormalCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:advertScrollViewNormalCell forIndexPath:indexPath];
...
#pragma mark - - - setting
- (void)setAdvertScrollViewStyle:( AdvertScrollViewStyle)advertScrollViewStyle {
    _advertScrollViewStyle = advertScrollViewStyle;
    if (advertScrollViewStyle ==  AdvertScrollViewStyleMore) {
        _advertScrollViewStyle =  AdvertScrollViewStyleMore;
        [_collectionView registerClass:[ AdvertScrollViewMoreCell class] forCellWithReuseIdentifier:advertScrollViewMoreCell];
    }
}
