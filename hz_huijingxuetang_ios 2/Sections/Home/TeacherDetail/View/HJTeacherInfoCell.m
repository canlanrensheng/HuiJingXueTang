...
@implementation HJTeacherInfoCell
...
- (void)setViewModel:(BaseViewModel *)viewModel indexPath:(NSIndexPath *)indexPath {
    ...
    HJTeacherInfoModel *model = listViewModel.teacherInfoArray[indexPath.row];
    if(model){
        ...
        self.dateLabel.text = [NSString stringWithFormat:@"%@/%@/%@",[NSString convertDateSingleData:date.year],[NSString convertDateSingleData:date.month],[NSString convertDateSingleData:date.day]];
    }
}
