//
//  HJInValidMyCardVoucherViewController.m
//  HuiJingSchool
//
...
@interface HJInValidMyCardVoucherViewController ()

@property (nonatomic,strong) HJMyCardVoucherViewModel *viewModel;

@end

@implementation HJInValidMyCardVoucherViewController
...
- (void)hj_loadData {
    ...
    self.viewModel.myCardVoucherType = MyCardVoucherTypeInvalid;
