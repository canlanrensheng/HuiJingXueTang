...
@interface HJAllOrderViewController ()

@property (nonatomic,strong) HJMyOrderViewModel *viewModel;

@end

@implementation HJAllOrderViewController
...
- (void)hj_loadData {
    ...
    self.tableView.mj_footer.hidden = YES;
    [self.viewModel getOrderListWithType:MyOrderTypeAll success:^{
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    DLog(@"获取到的数据的数量是:%ld",self.viewModel.orderListArray.count);
