...
@interface HJWaitPayViewController ()

@property (nonatomic,strong) HJMyOrderViewModel *viewModel;

@end

@implementation HJWaitPayViewController
...
- (void)hj_loadData {
    ...
    self.tableView.mj_footer.hidden = YES;
    [self.viewModel getOrderListWithType:MyOrderTypeWaitPay success:^{
